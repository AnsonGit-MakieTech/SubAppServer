...
var controller = null;
var connecting_to_unsafe_api = null;
var connecting_to_api = null;
var connecting_to_api_with_global_abort = null;

document.addEventListener("DOMContentLoaded", async()=>{

    let inside_csrftoken = csrftoken;
    csrftoken = null;
    
    connecting_to_unsafe_api = async( data )=>{
        let has_popup = false;
        ...
        try{
            ...
            const response = await fetch('../api/unauthenticated', {
                method: 'POST',
                headers: { 
                    'X-CSRFToken': inside_csrftoken,
                },
                body: formData
            });
    ...
    connecting_to_api_with_global_abort = async(data ) => {
